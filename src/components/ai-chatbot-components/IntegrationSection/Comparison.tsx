...
import { LuTrophy, LuSparkles, LuCheck } from "react-icons/lu";
...
const ComparisonSection: React.FC = () => {
  ...
  const aiQueries = [
    ...
    { query: "Predict next month's peak revenue hours.", category: "AI Forecasting (Beta)" },
        ...
        <div className="col-lg-6">
          ...
          >
            ...
            <div className="p-3 rounded-3 text-center d-flex align-items-center justify-content-center gap-2" style={{ background: "linear-gradient(90deg, rgba(0, 212, 255, 0.12) 0%, rgba(59, 130, 246, 0.12) 100%)", border: "1px solid rgba(0, 212, 255, 0.25)" }}>
              <Icon icon={LuSparkles} size={16} color="#00D4FF" />
              <span style={{ fontSize: "13px", color: "#fff", fontWeight: 500 }}>
                VenueGlide AI (Beta) transforms raw data into actionable revenue strategies in seconds.
              </span>
            </div>
          </div>
        </div>
