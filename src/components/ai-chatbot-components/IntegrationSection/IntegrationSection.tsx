                        ...
                        <div className="col-lg-6 mt-30">
                            <div className="integration-content">
                                <div className="sec-title sec-title--two process-title mb-10">
                                    <h2 className="title">Why Replace Multiple Systems?</h2>
                                    <span className="sub-title d-block mb-30">
                                        Most sports venues use separate software for: <br />
                                        VenueGlide combines everything into one connected operating system, reducing costs, eliminating duplicate data and giving your team one place to manage the entire venue.
                                    </span>
                                </div>
