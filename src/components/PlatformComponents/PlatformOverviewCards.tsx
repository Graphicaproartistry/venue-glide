      ...
      <div className="container">
        ...
        <div className="row g-4 align-items-stretch mb-4">
          ...
          <div className="col-lg-6 col-md-6 d-flex">
            <Reveal direction="up" delay={0.05} className="venueglide-overview-card w-100 d-flex flex-column justify-content-between p-4 p-md-5 rounded-4">
              <div>
          ...
          <div className="col-lg-6 col-md-6 d-flex">
            <Reveal direction="up" delay={0.1} className="venueglide-overview-card w-100 d-flex flex-column justify-content-between p-4 p-md-5 rounded-4">
              <div>
        ...
        <div className="row g-4 align-items-stretch">
          ...
          <div className="col-lg-6 col-md-6 d-flex">
            <Reveal direction="up" delay={0.15} className="venueglide-overview-card w-100 d-flex flex-column justify-content-between p-4 p-md-5 rounded-4">
              <div>
                ...
                <p className="card-desc" style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.75)", lineHeight: "1.6", marginBottom: "16px", minHeight: "44px" }}>
                  VenueGlide connects natively with the tools your venue already runs on:
                </p>
                ...
                <ul className="list-unstyled p-0 m-0 d-flex flex-column gap-2 mb-4">
                  {[
                    ...
                    "Igloo smart-lock staffless access",
          ...
          <div className="col-lg-6 col-md-6 d-flex">
            <Reveal direction="up" delay={0.2} className="venueglide-overview-card w-100 d-flex flex-column justify-content-between p-4 p-md-5 rounded-4">
              <div>
