                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6">
                        <div className="sec-title mb-30">
                            ...
                            <p className="content">
                                Discover how VenueGlide OS helps Australian sports venues automate operations, increase bookings, improve member experiences and grow revenue.
                            </p>

                            <div className="team-btn mt-40">
                                <Link className="thm-btn agency-btn" to="/contact">
                                    <span className="text">Book Your Personol Demo Today</span>
